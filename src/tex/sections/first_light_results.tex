...
\begin{figure}[t]
    \centering
    \script{neptune.py}
    \includegraphics[width=\textwidth]{figures/20230711_Neptune_flux.pdf}
    \caption{\label{fig:neptune_flux}}
\end{figure}
