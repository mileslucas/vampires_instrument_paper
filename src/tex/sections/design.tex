...
\begin{figure}
    ...
    \caption{Multiband observations of \textit{HD 204827} after frame selection, registration, and collapsing reveals a \si{75}{mas} binary. All data are rotated to North up and East left and shown in log stretch with the same limits in each frame.\label{fig:binary}}
\end{figure}
