...
\begin{equation}
    \theta_\mathrm{inst} = 180\text{\textdegree} - \theta_\mathrm{PAP} - \theta_\mathrm{off}
\end{equation}
where $\theta_\mathrm{PAP}$ is the static image rotator pupil offset of \ang{-39} to align with the SCExAO entrance pupil.
