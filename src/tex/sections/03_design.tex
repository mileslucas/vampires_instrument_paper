...
\begin{figure*}[t]
    ...
    \caption{VAMPIRES Instrument Schematic including all common path instruments: the telescope, waveplate unit (WPU), AO188, and SCexAO. Some components are simplified or omitted for clarity and are not to scale.}
    \label{fig:schematic}
\end{figure*}
...
Classic Lyot & IWA: 37, 59, 105, or 150 \si{\mas};\newline 5$\sigma$ contrast: $10^{\text{-}4}$ at \ang{;;0.1}, $10^{\text{-}6}$ at $>$\ang{;;0.5} & Sub-stellar companions, circumstellar disks \\
